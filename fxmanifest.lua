...
description 'LXRCore v3 love: consent-based paired interactions — hug, kiss, dance, proposal, slap; adult set off and empty by default'
version '3.0.0'
repository 'https://github.com/LXRCore/lxr-love'
